...
mol_comb_helper = MolCombHelper(2, 4096, getIC50, './data/100k_SMILES.txt')

print(mol_comb_helper.getAllFrags(
    Chem.MolFromSmiles("Cc1csc(-n2nnc(C(=O)Nc3cccnc3Cl)c2C)n1")))
